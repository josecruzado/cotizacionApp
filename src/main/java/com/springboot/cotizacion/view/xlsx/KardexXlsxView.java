package com.springboot.cotizacion.view.xlsx;
...
public class KardexXlsxView extends AbstractXlsxView {
	...
	protected void buildExcelDocument(Map<String, Object> model, Workbook workbook, HttpServletRequest request,
		...
		Cliente cliente = (Cliente) model.get("factura");
		...
		cell.setCellValue(cliente.getId() + " " + cliente.getRazonSocial());
